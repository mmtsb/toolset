...
double **submatrix(double **a, long oldrl, long oldrh, long oldcl, long,
...
void free_matrix(double **m, long nrl, long , long ncl, long )
...
void free_submatrix(double **b, long nrl, long , long , long )
/* free a submatrix allocated by submatrix() */
{
	free((FREE_ARG) (b+nrl-NR_END));
}

void free_convert_matrix(double **b, long nrl, long , long , long )
/* free a matrix allocated by convert_matrix() */
{
	free((FREE_ARG) (b+nrl-NR_END));
}

void free_f3tensor(double ***t, long nrl, long , long ncl, long ,
	long ndl, long )
